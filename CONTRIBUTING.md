# Contributing to Australia-Job-Finder

Thanks for your interest in contributing! Australia-Job-Finder is built with Claude Code, and you can use it for development too.
...
- Report bugs via [Issues](https://github.com/sum-kaur/australia-job-finder/issues)
...
- **PRs that enable auto-submitting applications** without human review. australia-job-finder is a decision-support tool, not a spam bot.
...
The "australia-job-finder" name itself is governed by [TRADEMARK.md](TRADEMARK.md).
...
- [Open an issue](https://github.com/sum-kaur/australia-job-finder/issues)
