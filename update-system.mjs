...
/**
 * update-system.mjs — Safe auto-updater for australia-job-finder
 *
...
const CANONICAL_REPO = 'https://github.com/sum-kaur/australia-job-finder.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/sum-kaur/australia-job-finder/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/sum-kaur/australia-job-finder/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'australia-job-finder-update-checker',
        },
