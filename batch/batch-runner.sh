...
# australia-job-finder batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
australia-job-finder batch runner — process job offers in batch via claude -p workers
...
main() {
  ...
  echo "=== australia-job-finder batch runner ==="
