...
australia-job-finder exists because of the people who build with it. thank you.
...
- **[@piscespieces](https://github.com/piscespieces)** (Andres Urdaneta) — Docs architect. Maintains the getting-started guides at [australia-job-finder-docs.vercel.app](https://australia-job-finder-docs.vercel.app). Shipped [PR #286](https://github.com/sum-kaur/australia-job-finder/pull/286) (portals cleanup). Authored the comparative analysis that defines what australia-job-finder is vs. isn't.

## Shipping with the project

- **[@CURT1S03](https://github.com/CURT1S03)** (Curtis) — LaTeX/Overleaf CV export ([PR #362](https://github.com/sum-kaur/australia-job-finder/pull/362), merged — resolves [#47](https://github.com/sum-kaur/australia-job-finder/issues/47))
- **[@vivek-gite](https://github.com/vivek-gite)** — A16Z provider support ([PR #271](https://github.com/sum-kaur/australia-job-finder/pull/271), in review)
