...
/**
 * test-all.mjs — Comprehensive test suite for australia-job-finder
 *
...
console.log('\n🧪 australia-job-finder test suite\n');
...
const leakPatterns = [
  'Santiago', 'sumneet.com', 'Santifer iRepair', 'Zinkee', 'ALMAS',
  'hi@sumneet.com', '688921377', '/Users/sum-kaur/',
];
