...
> "No active applications to follow up on. Apply to some roles first with `/australia-job-finder` and come back when they're aging."
...
- Suggest the user run `/australia-job-finder contacto {company}` to find the right person first
...
> - Trying a different contact via `/australia-job-finder contacto`
...
**To:** {email or "No contact found — run `/australia-job-finder contacto` first"}
