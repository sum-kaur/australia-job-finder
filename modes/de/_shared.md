# Geteilter Kontext -- australia-job-finder (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle australia-job-finder-Modi
     in der deutschen Variante. Bevor du australia-job-finder verwendest, MUSST du:
